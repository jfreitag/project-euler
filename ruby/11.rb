...
input_array.each_with_index do |e, i|
  array[i/20] = [] unless array.length > i/20
...
0.upto(max_index) do |x|
  0.upto(max_index) do |y|
    horizontal_product = get_safe_value(array, x, y) * get_safe_value(array, x+1, y) * get_safe_value(array, x+2, y) * get_safe_value(array, x+3, y)
